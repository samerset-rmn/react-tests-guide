...
Название каждого теста должно содержать его цель и действие. В начале ставится слово _should_, затем идет описание ожидаемого результата и в конце идет действие, которое должно привести к нему. Примеры:
...
- Бизнес-логика: `describe('Business logic businessLogicName')`

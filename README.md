...
2. [Изучение](#изучение)
   ...
   4. [Как правильно тестировать?](#как-правильно-тестировать)
        1. [Почему мы тестим только реализацию?](#почему-мы-тестим-только-реализацию)
...
#### Почему мы тестим только реализацию?
